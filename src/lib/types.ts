  ...
  export const CATEGORIES = ["전체", "과일/채소", "정육", "계란", "수산/건어물", "쌀/잡곡/견과", "햄/어묵", "유제품", "두부/콩나물", "냉장밀키트", "생수/음료", "단무지", "떡/냉장면", "냉동식품", "간식", "빵", "라면", '건면/당면', "즉석식품", "통조림", "장류/소스/양념", "조미료/향신료", "식용유/참기름", "밀가루/가루", "커피/차", "주방/세탁/청소용품", "세안", "화장지", "방충", "기저귀/생리대", "잡화", "반려동물", "미분류" ] as const;
